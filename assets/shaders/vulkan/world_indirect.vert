...
layout(location = 6) out vec2 vertexSourceUv1;
layout(location = 7) out vec2 vertexSourceUv2;
layout(location = 8) flat out uint drawStateIndex;
...
#include "project_world_indirect_vertex_evaluation.glsl"
#endif
