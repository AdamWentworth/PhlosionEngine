...
public:
  explicit OpenGLRenderBackend(const engine::render::WorldMaterialProfile &profile = {});
...
private:
    ...
    struct WorldIndexedBatchSubmissionState {
        ...
        std::array<int, 8> prevTexture2DOnUnit{0, 0, 0, 0, 0, 0, 0, 0};
        ...
        std::array<int, 8> currentTexture2DOnUnit{0, 0, 0, 0, 0, 0, 0, 0};
